...
class UserForm(UserCreationForm):
    first_name = forms.CharField(max_length=30, required=True,
                                 widget=forms.TextInput(attrs={'plaecholder':"*Your first name..."}))
    last_name = forms.CharField(max_length=30, required=True,
                                 widget=forms.TextInput(attrs={'plaecholder':"*Your last name..."}))
...
# PER I DETTAGLI DEL PROFILO ASSOCIATO ALLO USER
class UserProfileForm(forms.ModelForm):
    ...
    latitude = forms.CharField(vmax_length=50, required=True,widget=forms.HiddenInput())
